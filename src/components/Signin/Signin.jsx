...
export const Signin = () => {
  ...
  <div className="icon">
   ...
   <div className="hu"> <img src="https://th.bing.com/th/id/OIP.1Nl9otEDi23qnVEQXPJuKQHaHa?w=162&h=180&c=7&r=0&o=5&pid=1.7 "  alt="" className="zz"/><span className="ggl" >Google</span></div>
    ...
    <div className="kk">
    <img src="https://th.bing.com/th/id/OIP.ZukVvz62s21LSc4we5WeagHaHa?w=185&h=181&c=7&r=0&o=5&pid=1.7"  alt="" className="pic"/>
    <input placeholder="Enter Your Email/Mobile" type="text" className="cc"  ></input>
    </div>

    <div className="kk1">
    <img src="https://th.bing.com/th/id/OIP.fC2yOxAzBsS2Kv5Vo2jgegHaHa?w=162&h=180&c=7&r=0&o=5&pid=1.7 "  alt="" className="pic"/>
    <input placeholder="Enter Your Password" type="text" className="cc"  ></input>
    </div>
    <div className="me">
        <input type="checkbox" />
    ...
    <div className="blue">
        <p3 className="b"><b>Forget Password? </b></p3>
        <p3 className="b"><b>Login via OTP</b></p3>
    </div>
    <button className="ss" type="submit">Log In</button>
